 ...
 * @LastEditors: Orginly
 * @LastEditTime: 2021-02-12 00:23:05
-->
<template>
  <a-modal
    :title="title"
    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="手机号">
          <a-input
            v-decorator="['mobile', { rules: [{ required: true, len: 11, message: '请输入正确的手机号' }] }]"
            placeholder="请输入手机号"
          />
        </a-form-item>
...
// 表单字段
const fields = ['mobile', 'mobile_area', 'password', 'password_confirm', 'nickname', 'id']
